...
class CaseStudiesInner extends Component {
  render() {
    return (
      ...
      <HText classs="font-bold text-3xl" >
        The details
      </HText>
      <HText>
...
There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of text. All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary, making this the first true generator on the Internet. It uses a dictionary of over 200 Latin words, combined with a handful of model sentence structures, to generate Lorem Ipsum which looks reasonable. The generated Lorem Ipsum is therefore always free from repetition, injected humour, or non-characteristic words etc.
      ...
      <HText classs="font-medium text-lg">Get Webber for your organization</HText>
      <HText classs="text-sm">
      There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look.
      </HText>
      <div class="grid grid-flow-col gap-2">
      <WebButton class="place-self-center rounded-sm  text-blue-100 bg-white ">Start trial</WebButton>
      <WebButton class="place-self-center rounded-sm  text-white border-2 border-white bg-transparent ">Contact sales</WebButton>
      </div>
      </div>
      </div>
        </div>
...
<Studies  src="https://i.postimg.cc/CKcFPp2j/Project-Cover.png" sub="Technology - SaaS" heading="Adobe Systems Inc" desc="Learn how Adobe has leveraged Webber to consolidate it’s diverse range of services software" >
</Studies>
...
<Studies  src="https://i.postimg.cc/QxgJyjQ9/Project-Cover-1.png" sub="Technology - SaaS" heading="Gutkowski, Schuppe and Pagac" desc="Learn how Adobe has leveraged Webber to consolidate it’s diverse range of services software">
</Studies>
<Studies src="https://i.postimg.cc/prfz4BFb/Project-Cover-2.png" sub="Airline" heading="Swiss Airline" desc="Learn how Trello has leveraged Webber to consolidate it’s diverse range of services software">
        ...
        <hr class=""/>       
<footer class="bg-gray-50  grid grid-flow-col gap-8 p-20 ">
