...
function Studies({classs,src,sub,heading,desc}) {
  ...
  return (
             ...
             <div class="place-self-center grid grid-flow-row w-4/5 gap-2">
                 <div class={classs} >
    <img class="rounded-sm mb-2"  src={src} />
    ...
    <a class="underline text-cyan-800">Read story</a><svg class="place-self-center"  width="14" height="8" viewBox="0 0 14 8" fill="none" xmlns="http://www.w3.org/2000/svg">
