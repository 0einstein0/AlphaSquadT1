      ...
      <div>
        <div class=" w-full bg-blue-10 h-xxl">
          ...
          <div class="  items-center  px-16 py-7  ">
            <div class="md:place-self-center grid grid-flow-row ">
              <HText classs="mb-16 font-extrabold text-center text-4xl  md:text-6xl leading-normal">
                Business Inspiration To Bring Innovative Ideas To Life
              </HText>
        ...
        <footer class="bg-gray-100 p-10 mx-auto grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 pt-6  ">
          <div class=" ">
            <div class=" ">
              <img
                class=" w-2/4 object-left "
                src="https://i.postimg.cc/VsZZPF9S/logo.png"
              />
            </div>
            <div>
